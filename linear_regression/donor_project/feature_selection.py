...
'''
rfc = RandomForestClassifier(random_state=42, n_estimators=1500, max_features=0.3, max_depth=10)
...
# prediction with full data
best_predictions = ab_clf.predict(X_test)
...
# Train on the "best" model found from grid search earlier
clf = (clone(ab_clf)).fit(X_train_reduced, y_train)
